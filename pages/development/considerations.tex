...
La estructura del código se ha diseñado para que sea lo más modular posible,
de forma que cada modulo tenga una única responsabilidad y sea fácilmente
intercambiable. La distribución de ficheros y carpetas se puede ver en la 
Figura \ref{fig:estrcutra-ficheros}.
...
\begin{itemize}
    ...
    \item \textbf{Mypy:} Mypy \cite{mypy} es una herramienta de análisis estático para Python que permite a los 
